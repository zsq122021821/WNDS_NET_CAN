...
//////////////////////////////////////////////////////////////////////////
//兼容ZLG的函数
typedef unsigned int (*LPVCI_OpenDevice)(unsigned int,unsigned int,unsigned int);
typedef unsigned int (*LPVCI_CloseDevice)(unsigned int,unsigned int);
typedef unsigned int (*LPVCI_InitCan)(unsigned int,unsigned int,unsigned int,PVCI_INIT_CONFIG);

typedef unsigned int (*LPVCI_ReadBoardInfo)(unsigned int,unsigned int,PVCI_BOARD_INFO);
typedef unsigned int (*LPVCI_ReadErrInfo)(unsigned int,unsigned int,unsigned int,PVCI_ERR_INFO);
typedef unsigned int (*LPVCI_ReadCanStatus)(unsigned int,unsigned int,unsigned int,PVCI_CAN_STATUS);

typedef unsigned int (*  LPVCI_GetReference)(unsigned int,unsigned int,unsigned int,unsigned int,void *);
typedef unsigned int (*  LPVCI_SetReference)(unsigned int,unsigned int,unsigned int,unsigned int,void *);

typedef unsigned long (*  LPVCI_GetReceiveNum)(unsigned int,unsigned int,unsigned int);
typedef unsigned int (*  LPVCI_ClearBuffer)(unsigned int,unsigned int,unsigned int);

typedef unsigned int (*  LPVCI_StartCAN)(unsigned int,unsigned int,unsigned int);
typedef unsigned int (*  LPVCI_ResetCAN)(unsigned int,unsigned int,unsigned int);

typedef unsigned long (*  LPVCI_Transmit)(unsigned int,unsigned int,unsigned int,PVCI_CAN_OBJ,unsigned long);
typedef unsigned long (*  LPVCI_Receive)(unsigned int,unsigned int,unsigned int,PVCI_CAN_OBJ,unsigned long,int);
...
//其他函数
typedef unsigned int (*  LPVCI_GetReference2)(unsigned int,unsigned int,unsigned int,unsigned int,PVCI_REF_STRUCT);
typedef unsigned int (*  LPVCI_SetReference2)(unsigned int,unsigned int,unsigned int,unsigned int,void *);
typedef unsigned int (*  LPVCI_ResumeConfig)(unsigned int,unsigned int,unsigned int);

typedef unsigned int (*  LPVCI_ConnectDevice)(unsigned int,unsigned int);
typedef unsigned int (*  LPVCI_UsbDeviceReset)(unsigned int,unsigned int,unsigned int);
typedef unsigned int (*  LPVCI_FindUsbDevice)(PVCI_BOARD_INFO1);
